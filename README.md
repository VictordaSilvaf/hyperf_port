...
Sem Swoole no host, o exemplo de integração pode aparecer como *skipped*; no container Hyperf deve passar na íntegra.
...
Este projeto base segue a licença indicada em [LICENSE](LICENSE) e em [composer.json](composer.json) (Apache-2.0 no *skeleton* oficial Hyperf).
